...
const CATEGORIES: FaqCategory[] = [
  {
    ...
    items: [
      {
        q: "東海システムはどんな会社ですか？",
        a: "名古屋・名駅を拠点に、業務システム開発・ITインフラ・SESを提供する会社です。製造・物流の現場を支えることを得意としています。",
      },
      {
        q: "どんな業界のお客様が多いですか？",
        a: "東海圏の製造業・物流業が中心です。生産管理・在庫・受発注など、毎日動き続ける業務システムを多く手がけています。",
      },
      {
        q: "会社の雰囲気は？",
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "開発とインフラ、どちらも経験できますか？",
        a: "はい。アプリと基盤を分断しない体制のため、希望に応じて両方の経験を積むことができます。",
      },
      {
        q: "常駐先はどのように決まりますか？",
        a: "希望とスキル、現場との相性を重ねて決定します。会社都合だけのアサインは行いません。",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: "勤務地はどこですか？",
        a: "原則として東海圏（愛知・岐阜・三重）です。遠方への出張・常駐は、本人の同意のうえで決定します。",
      },
      {
        q: "担当変更は頻繁にありますか？",
